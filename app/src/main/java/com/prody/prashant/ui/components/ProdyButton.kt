...
/**
 * Circular icon button with proper touch target, premium interactions, and tooltip support.
 */
    ...
    val buttonContent = @Composable { contentModifier: Modifier ->
        Surface(
            ...
            modifier = contentModifier
                ...
                .semantics {
                    role = Role.Button
                    val finalDescription = contentDescription ?: tooltip
                    if (finalDescription != null) {
                        this.contentDescription = finalDescription
                    }
                },
            enabled = enabled,
            ...
            Icon(
                imageVector = icon,
                contentDescription = null, // Accessibility handled by Surface
                modifier = Modifier
                    .padding(12.dp)
                    .size(24.dp),
