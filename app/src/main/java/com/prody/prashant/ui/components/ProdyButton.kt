    ...
    val buttonContent = @Composable {
        Surface(
            ...
            modifier = modifier
                ...
                .semantics {
                    role = Role.Button
                    // Use tooltip as content description if none provided
                    val description = contentDescription ?: tooltip
                    if (description != null) {
            ...
            Icon(
                imageVector = icon,
                contentDescription = null, // Description handled by Surface semantics
                modifier = Modifier
                    .padding(12.dp)
                    .size(24.dp),
