...
/**
 * Circular icon button with proper touch target, optional tooltip, and background.
 */
@Composable
fun ProdyIconButton(
    icon: ImageVector,
    ...
    val iconButtonContent = @Composable {
        Surface(
            onClick = {
                haptic.click()
                onClick()
            ...
            Box(
                ...
                Icon(
                    imageVector = icon,
                    contentDescription = null, // Content description handled by Surface semantics
