...
class VocabularyReviewViewModel @Inject constructor(
    ...
    private fun loadVocabularyReview() {
        viewModelScope.launch {
            ...
            try {
                // Architecture Pattern: Fetch userId asynchronously to ensure non-blocking
                // ViewModel lifecycle and handle PreferencesManager API change.
                ...
                val growthData = calculateGrowthData(allLearnedWords, userId)
     ...
     */
    private suspend fun calculateGrowthData(
        learnedWords: List<VocabularyEntity>,
        userId: String
    ): List<VocabularyGrowthPoint> {
