...
class OnboardingViewModel @Inject constructor(
    ...
    fun completeOnboarding() {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                // Optimization: Wrap Room database operations in a single transaction.
                // Architectural Insight: Non-Room operations like DataStore (preferencesManager)
                // should stay outside to avoid blocking or consistency issues.
                ...
                // Update preferences outside the Room transaction
