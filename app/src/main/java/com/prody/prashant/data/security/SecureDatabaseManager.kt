...
class SecureDatabaseManager @Inject constructor(
    ...
    fun getDatabasePassphraseSync(): String {
        try {
            ...
            throw SecurityException("Failed to securely retrieve or generate database passphrase. Fail-Secure policy enforced.", e)
        }
    }
    ...
    /**
     * Generate a secure database key using 256-bit high-entropy data.
     */
