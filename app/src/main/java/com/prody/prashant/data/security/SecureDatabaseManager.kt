...
class SecureDatabaseManager @Inject constructor(
    ...
    fun getDatabasePassphraseSync(): String {
        return try {
            ...
            Log.e(TAG, "Security Critical: Error getting database passphrase. Failing secure.", e)
            throw SecurityException("Failed to securely retrieve or generate database passphrase", e)
        }
    }
