...
abstract class ProdyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Builds the database instance with SQLCipher encryption.
         * Security: Always use encryption for production-grade data protection.
         */
private fun buildDatabase(context: Context): ProdyDatabase {
            ...
            // Create SQLCipher support factory with secure passphrase (synchronous)
