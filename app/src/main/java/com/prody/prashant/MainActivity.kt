...
/**
 * Performance-optimized breathing pulse icon for Haven FAB.
 * Isolated into its own Composable to localize recompositions and uses
 * graphicsLayer to defer animation state reads to the drawing phase.
 */
@Composable
private fun HavenPulseIcon(
    ...
    Box(
        modifier = Modifier
            .size(56.dp)
            .graphicsLayer {
                // State reads are deferred to the drawing phase
