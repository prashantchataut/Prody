...
/**
 * Performance Optimization: Isolated breathing pulse for the Haven FAB.
 * Using graphicsLayer to defer state reads to the drawing phase,
 * preventing unnecessary recompositions of the NavigationBar.
 */
@Composable
private fun HavenPulseFAB(
    isSelected: Boolean,
    ...
    Box(
        modifier = Modifier
            ...
            .graphicsLayer {
                scaleX = scale
                scaleY = scale
                alpha = if (isSelected) 1f else animatedAlpha
            }
            .clip(CircleShape)
            .background(
