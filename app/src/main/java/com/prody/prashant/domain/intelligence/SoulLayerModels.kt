...
data class UserContext(
    ...
    val preferredFeatures: List<Feature>,
...
/**
 * Available features in the app for tracking preferences.
 */
enum class Feature(val displayName: String, val unlockDay: Int) {
    JOURNAL("Journal", 0),
...
sealed class NotificationDecision {
    ...
    data class Modify(val newContent: NotificationContent, val reason: String) : NotificationDecision()
...
/**
 * Notification content that can be personalized.
 */
