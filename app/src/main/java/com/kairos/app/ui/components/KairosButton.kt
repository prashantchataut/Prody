 ...
 */
enum class KairosButtonSize {
    SMALL,
    MEDIUM,
    LARGE
}

private object KairosButtonDefaults {
...
val CornerRadius = KairosTokens.Radius.sm
}
...
fun KairosPrimaryButton(
    ...
    size: KairosButtonSize = KairosButtonSize.MEDIUM,
    ...
    val height = when (size) {
        KairosButtonSize.SMALL -> KairosButtonDefaults.SmallHeight
        KairosButtonSize.MEDIUM -> KairosButtonDefaults.MediumHeight
        KairosButtonSize.LARGE -> KairosButtonDefaults.LargeHeight
    }

    val horizontalPadding = when (size) {
        KairosButtonSize.SMALL -> KairosButtonDefaults.SmallHorizontalPadding
        KairosButtonSize.MEDIUM -> KairosButtonDefaults.MediumHorizontalPadding
        KairosButtonSize.LARGE -> KairosButtonDefaults.LargeHorizontalPadding
    }
    ...
    Button(
        ...
        shape = RoundedCornerShape(KairosButtonDefaults.CornerRadius),
...
private fun ButtonContent(
    ...
    val textStyle = when (size) {
        KairosButtonSize.SMALL -> MaterialTheme.typography.labelMedium
        KairosButtonSize.MEDIUM -> MaterialTheme.typography.labelLarge
        KairosButtonSize.LARGE -> MaterialTheme.typography.titleSmall
    }
    ...
    Row(
        ...
        if (loading) {
            CircularProgressIndicator(
                modifier = Modifier.size(KairosButtonDefaults.LoadingIndicatorSize),
                color = contentColor,
                strokeWidth = 2.dp
            )
            Spacer(modifier = Modifier.width(KairosButtonDefaults.IconTextGap))
...
fun KairosIconButton(
    ...
    size: Dp = KairosTokens.Touch.minimum
) {
    val interactionSource = remember { MutableInteractionSource() }
    val haptic = rememberKairosHaptic()
    val isPressed by interactionSource.collectIsPressedAsState()
