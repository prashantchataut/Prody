...
private fun getErrorIcon(errorType: ErrorType): ImageVector {
    return when (errorType) {
        ErrorType.NETWORK -> KairosIcons.CloudOff
        ErrorType.DATABASE -> KairosIcons.Storage
        ErrorType.AI_SERVICE -> KairosIcons.Warning
        ErrorType.TIMEOUT -> KairosIcons.Timer
        ErrorType.RATE_LIMIT -> KairosIcons.Timer
        else -> KairosIcons.Error
    }
}
