...
class StatsViewModel @Inject constructor(
    ...
    private data class StatsData(
        val profile: com.kairos.app.data.local.entity.UserProfileEntity?,
        val history: List<com.kairos.app.data.local.entity.StreakHistoryEntity>,
        val moodCounts: List<com.kairos.app.data.local.dao.MoodCount>,
        val wordCount: Int?
    )
