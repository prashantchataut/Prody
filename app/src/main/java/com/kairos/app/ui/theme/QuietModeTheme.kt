...
object QuietModeTheme {
    ...
    fun applyQuietMode(
        ...
        return when (normalColor) {
            KairosAccentGreen -> if (isDarkMode) QuietAccentDark else QuietAccentLight
            KairosBackgroundLight -> QuietBackgroundLight
            KairosBackgroundDark -> QuietBackgroundDark
            KairosSurfaceLight -> QuietSurfaceLight
            KairosSurfaceDark -> QuietSurfaceDark
            KairosTextPrimaryLight -> QuietTextPrimaryLight
            KairosTextPrimaryDark -> QuietTextPrimaryDark
