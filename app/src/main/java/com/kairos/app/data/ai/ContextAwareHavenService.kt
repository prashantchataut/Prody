...
import com.kairos.app.domain.haven.HavenAiResponse
import com.kairos.app.domain.haven.HavenMessage
import com.kairos.app.domain.haven.SessionType
import com.kairos.app.domain.intelligence.StressSignal
import com.kairos.app.domain.intelligence.StressSignalType
import com.kairos.app.domain.intelligence.TherapeuticApproach
import com.kairos.app.domain.intelligence.TrustLevel
import com.kairos.app.domain.intelligence.UserContext
import com.kairos.app.domain.intelligence.UserContextEngine
...
private typealias HavenSessionContext = com.kairos.app.domain.haven.HavenConversationContext
private typealias SoulLayerHavenContext = com.kairos.app.domain.intelligence.HavenContext
...
class ContextAwareHavenService @Inject constructor(
    ...
    private fun inferSessionFromMood(mood: com.kairos.app.domain.model.Mood): SessionType {
        return when (mood) {
            com.kairos.app.domain.model.Mood.ANXIOUS -> SessionType.ANXIETY
            com.kairos.app.domain.model.Mood.SAD -> SessionType.SADNESS
            com.kairos.app.domain.model.Mood.CONFUSED -> SessionType.GENERAL
