...
import com.kairos.app.domain.identity.ProfileLoadout
...
data class ProfileLoadoutEntity(
    ...
    /** Selected banner ID from KairosBanners */
    val bannerId: String,

    /** Selected frame ID from KairosFrames */
    val frameId: String,

    /** Selected title ID from KairosTitles */
    val titleId: String,
