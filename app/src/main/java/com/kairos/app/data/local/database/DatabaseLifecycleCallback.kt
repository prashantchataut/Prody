...
open class DatabaseLifecycleCallback(
    ...
    private val databaseProvider: () -> KairosDatabase?
...
class SecureDatabaseLifecycleCallback(
    ...
    tag: String,
    databaseProvider: () -> KairosDatabase?
    ...
    override fun onOpen(db: SupportSQLiteDatabase) {
        ...
        scope.launch {
            try {
                ...
                if (!isIntegrityValid) {
                    Log.e("KairosDatabase", "Database integrity check failed!")
                }
            } catch (e: Exception) {
                Log.e("KairosDatabase", "Database integrity check error", e)
            }
        }
    }
