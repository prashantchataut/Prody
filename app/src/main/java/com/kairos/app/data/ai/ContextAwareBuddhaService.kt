...
class ContextAwareBuddhaService @Inject constructor(
    ...
    private fun buildContextAwareJournalPrompt(
        ...
        return buildString {
            ...
            append("Days with Kairos: ${userContext.daysWithKairos}\n")
    ...
    private fun buildStreakCelebrationPrompt(
        ...
        return buildString {
            ...
            append("- Days with Kairos: ${context.daysWithKairos}\n")
            append("- User type: ${describeArchetype(context.userArchetype)}\n")
            appendLine()
    ...
    private fun describeSpecialDay(day: SpecialDay): String {
        return when (day) {
            ...
            is SpecialDay.KairosAnniversary -> "${day.yearsWithKairos} year anniversary with Kairos"
...
- Make them feel like Kairos is glad to see them
...
This person is brand new to Kairos. Your response MUST:
...
## About Your Creator
Kairos was built by Prashant Chataut, a 16-year-old developer from Nepal studying Science in Grade XI. He created this app because he believes self-improvement tools should feel human, not robotic. When users ask about Prashant or who made Kairos, speak warmly about him.
