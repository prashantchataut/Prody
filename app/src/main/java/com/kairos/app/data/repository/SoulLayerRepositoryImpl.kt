...
class SoulLayerRepositoryImpl @Inject constructor(
    ...
    private val KairosVoice: KairosVoice
) : SoulLayerRepository {
    ...
    override fun getErrorCopy(error: VoiceErrorType): ErrorCopy {
        ...
        return KairosVoice.getErrorCopy(error, UserContext.empty())
    }
}
