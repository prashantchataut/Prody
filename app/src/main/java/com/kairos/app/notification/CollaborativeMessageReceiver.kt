...
import com.kairos.app.domain.collaborative.CollaborativeMessageScheduler
import com.kairos.app.domain.collaborative.MessageDeliveryService
    ...
    private fun handleOccasionReminder(intent: Intent) {
        ...
        scope.launch {
            try {
                ...
                if (contactResult is com.kairos.app.domain.common.Result.Success) {
                    ...
                    if (occasionResult is com.kairos.app.domain.common.Result.Success) {
