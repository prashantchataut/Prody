 ...
 * ```
 * @Composable
 * fun KairosApp(preferencesManager: PreferencesManager) {
 ...
 */
@Composable
fun rememberKairosHaptic(): KairosHapticFeedback {
    val hapticFeedback = LocalHapticFeedback.current
    val isEnabled = LocalHapticEnabled.current

    return remember(hapticFeedback, isEnabled) {
        KairosHapticFeedback(hapticFeedback, isEnabled)
    }
}
 ...
 *     val haptic = rememberKairosHaptic(preferencesManager)
 *
 *     Button(onClick = {
 *         haptic.click()
 *         // ... action
 ...
 */
@Composable
fun rememberKairosHaptic(preferencesManager: PreferencesManager): KairosHapticFeedback {
    val hapticFeedback = LocalHapticFeedback.current
    val isEnabled by preferencesManager.hapticFeedbackEnabled.collectAsStateWithLifecycle(initialValue = true)
 ...
 */
@Composable
fun rememberKairosHaptic(hapticEnabledFlow: Flow<Boolean>): KairosHapticFeedback {
    val hapticFeedback = LocalHapticFeedback.current
    val isEnabled by hapticEnabledFlow.collectAsStateWithLifecycle(initialValue = true)
...
/**
 * Extension function to create a KairosHapticFeedback directly from HapticFeedback.
 * Use this when you already know the enabled state.
 */
fun HapticFeedback.toKairosHaptic(isEnabled: Boolean): KairosHapticFeedback {
    return KairosHapticFeedback(this, isEnabled)
}
