...
/**
 * [KairosAchievements] - Comprehensive achievement system for Kairos
 *
 ...
 *
 * Achievements are organized into categories aligned with Kairos's core pillars:
 ...
 * Example usage:
 * ```
 * val achievement = KairosAchievements.findById("first_word")
 * val wisdomAchievements = KairosAchievements.getByCategory(Category.WISDOM)
 * ```
 */
object KairosAchievements {

    /**
     * Achievement categories aligned with Kairos's core pillars of personal growth.
     *
    ...
    enum class Category(
        ...
        EXPLORER(
            ...
            description = "Achievements from exploring all Kairos features",
            iconName = "explore",
    ...
    /**
     * Complete list of all achievements in Kairos.
    ...
    val allAchievements: List<Achievement> = buildList {
        ...
        add(
            Achievement(
                ...
                rarity = Rarity.RARE,
                requirement = 1,
                requirementDescription = "Use all Kairos features in a single day",
                iconName = "check_circle",
                celebrationMessage = "A day fully lived within Kairos. This is presence.",
                rewardPoints = 300
            )
        )
        add(
        ...
        add(
            Achievement(
                ...
                rarity = Rarity.LEGENDARY,
                requirement = 1,
                requirementDescription = "Use Kairos within its first month of existence",
                iconName = "foundation",
        ...
        add(
            Achievement(
                id = "feature_master",
                name = "Feature Master",
                description = "Explored every corner of Kairos",
                category = Category.EXPLORER,
                rarity = Rarity.EPIC,
                requirement = 1,
                requirementDescription = "Use all major Kairos features at least once",
                iconName = "apps",
                celebrationMessage = "You've explored all of Kairos. You are a true master!",
                rewardPoints = 500
            )
        )
        add(
        ...
        add(
            Achievement(
                ...
                rarity = Rarity.UNCOMMON,
                requirement = 5,
                requirementDescription = "Use Kairos between midnight and 4 AM, 5 times",
                iconName = "bedtime",
        ...
        add(
            Achievement(
                ...
                rarity = Rarity.RARE,
                requirement = 8,
                requirementDescription = "Use Kairos on 8 consecutive weekend days",
                iconName = "weekend",
