...
/**
 * [KairosRanks] - Wisdom-inspired rank system for Kairos
 *
 ...
 * Example usage:
 * ```
 * val currentRank = KairosRanks.Rank.fromPoints(userPoints)
 * val nextRank = KairosRanks.Rank.getNextRank(currentRank)
 * ```
 */
object KairosRanks {
