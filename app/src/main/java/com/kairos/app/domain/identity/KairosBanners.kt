 ...
 * Example usage:
 * ```
 * val availableBanners = KairosBanners.getAvailableBanners(
 *     currentLevel = 5,
 *     daysOnApp = 30,
...
object KairosBanners {
    ...
    /**
     * Complete list of all available banners in Kairos.
     */
    val allBanners: List<Banner> = listOf(
        ...
        Banner(
            ...
            unlockRequirement = "Use Kairos before 7 AM for 7 days",
        ...
        Banner(
            ...
            unlockRequirement = "Use Kairos after 10 PM for 7 days",
        ...
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 7 days",
            gradientColors = listOf(0xFF56CCF2, 0xFF2F80ED),
            patternType = PatternType.WAVES,
            requiredDays = 7
        ),
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 14 days",
            gradientColors = listOf(0xFF667EEA, 0xFF764BA2),
            patternType = PatternType.WAVES,
            requiredDays = 14
        ),
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 30 days",
            gradientColors = listOf(0xFF4ECDC4, 0xFF44B09E),
            patternType = PatternType.AURORA,
            requiredDays = 30
        ),
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 60 days",
            gradientColors = listOf(0xFF2C3E50, 0xFF4CA1AF),
            patternType = PatternType.AURORA,
            requiredDays = 60
        ),
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 90 days",
        ...
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 180 days",
        ...
        Banner(
            ...
            unlockRequirement = "Be on Kairos for 365 days",
