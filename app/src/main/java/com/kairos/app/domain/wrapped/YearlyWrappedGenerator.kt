...
import com.kairos.app.data.local.entity.YearlyWrappedEntity
...
// Collect all data using proper Flow collection
        val journalEntries: List<com.kairos.app.data.local.entity.JournalEntryEntity> = try {
    ...
    private fun calculateStats(
        entries: List<com.kairos.app.data.local.entity.JournalEntryEntity>,
        yearStart: Long,
        yearEnd: Long,
        userId: String
    ): YearStats {
