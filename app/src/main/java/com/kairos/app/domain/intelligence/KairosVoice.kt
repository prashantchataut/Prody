...
/**
 * ================================================================================================
 * Kairos VOICE - The Unified Copywriting System
 * ================================================================================================
 *
 * Every piece of text in Kairos should feel like it comes from the same caring, wise,
 ...
 *
 * This is how Kairos speaks. Every string should pass through this lens.
 */
@Singleton
class KairosVoice @Inject constructor() {
    ...
    fun getCelebrationCopy(celebration: CelebrationType, context: UserContext): CelebrationCopy {
        return when (celebration) {
            ...
            CelebrationType.WEEK_COMPLETE -> CelebrationCopy(
                ...
                message = "You've built a real habit. The first week is the hardest, and you did it! The full Kairos experience now awaits.",
                encouragement = "You're officially a Kairos journaler now."
            )
    ...
    fun getEmptyStateCopy(location: EmptyStateLocation, context: UserContext): EmptyStateCopy {
        return when (location) {
            ...
            EmptyStateLocation.MEMORIES -> EmptyStateCopy(
                ...
                message = "As you continue journaling, Kairos will surface meaningful memories at the right moments.",
                ctaLabel = null,
                ctaRoute = null
            )
    ...
    private fun getSpecialDayGreeting(specialDay: SpecialDay, firstName: String): String {
        return when (specialDay) {
            ...
            is SpecialDay.KairosAnniversary -> "Happy ${specialDay.yearsWithKairos} year anniversary, $firstName!"
    ...
    private fun getHomeSubtitle(context: UserContext): String {
        return when {
            context.specialDay is SpecialDay.KairosAnniversary -> "Look how far you've come!"
    ...
    private fun getHomeSecondaryCta(context: UserContext): String {
        return when {
            !context.hasTalkedToHaven && context.daysWithKairos >= 4 -> "Meet Haven"
            context.isStruggling -> "Talk to Haven"
...
/**
 * Error types for Kairos voice responses.
 *
 * Renamed from ErrorType to avoid collision with
 * com.kairos.app.domain.common.ErrorType.
 */
