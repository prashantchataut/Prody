package com.kairos.app.domain.social
...
enum class NudgeType(val emoji: String, val defaultMessage: String, val color: Color) {
    ...
    MISS_YOU("👋", "We miss you in the circle!", KairosInfo),
    PROUD("⭐", "So proud of your commitment!", KairosSuccess),
    KEEP_IT_UP("🔥", "Keep that streak alive!", StreakColor),
    AWESOME("✨", "You're doing awesome!", KairosAccentGreen);
 ...
 * com.kairos.app.domain.intelligence.NotificationType.
 */
