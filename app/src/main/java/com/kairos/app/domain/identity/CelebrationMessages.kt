...
/**
 * [CelebrationMessages] - Elegant messaging system for Kairos
 *
...
object CelebrationMessages {
     ...
     */
    fun dailyGreetingWithRank(displayName: String, rank: KairosRanks.Rank, hour: Int): String {
        return KairosRanks.RankMessages.greetingForRank(rank, displayName)
    }
