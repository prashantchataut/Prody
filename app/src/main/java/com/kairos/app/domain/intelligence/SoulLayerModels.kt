...
/**
 * ================================================================================================
 * Kairos SOUL LAYER - INTELLIGENCE MODELS
 * ================================================================================================
 *
 * The Soul Layer is the invisible intelligence that makes Kairos feel alive.
...
/**
 * The brain of Kairos's understanding of a user.
 ...
 * com.kairos.app.domain.wellbeing.Feature.
 */
 ...
 * com.kairos.app.domain.wrapped.GrowthArea.
 */
...
sealed class SpecialDay(val displayName: String, val shouldCelebrate: Boolean = true) {
    ...
    data class KairosAnniversary(val yearsWithKairos: Int) : SpecialDay(
        "Your Kairos Anniversary",
 ...
 * com.kairos.app.data.content.NotificationContent object.
 */
...
/**
 * A synthesized insight generated by Kairos's intelligence layer.
 */
